...
const ToggleButtons = () => {
  ...
  const gameSubCategories = ['Action', 'Adventure', 'RPG', 'Shooter', 'Action', 'Adventure', 'RPG', 'Shooter'];
  const sportsSubCategories = ['Football', 'Basketball', 'Tennis', 'Cricket', 'Football', 'Basketball', 'Tennis', 'Cricket'];

  return (
    <div className="flex flex-col items-center gap-4 bg-black p-4 rounded-lg w-full max-w-lg mx-auto md:w-2/3 lg:w-1/2">
